...
- **Model**: Stores the state of your todos, cursor position, and input fields.
- **Update**: Handles keyboard events and updates the state (e.g., adding a task, toggling completion, moving the cursor).
